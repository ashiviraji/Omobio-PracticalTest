...
let data = JSON.parse(sessionStorage.getItem("userData"));
//console.log(data);
this.setState({name:data.userData.name,email:data.userData.email,user_id:data.userData.user_id,username:data.userData.username});
...
<Link to="#"  style={{color:"darkgreen"}} onClick={this.logout} className="logout">Logout</Link>
